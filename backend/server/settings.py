...
SECRET_KEY = 'django-insecure-%gb8p%$iqvy*nqbyo3n-yv5z79%qc73+g$3vw$6vgg%#7qhp$v'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # <- add this line to change templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [BASE_DIR / 'django_static/staticfiles_dirs', ]
MEDIA_URL = '/media/'
